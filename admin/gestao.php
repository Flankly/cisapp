...
<div class="card-header"><i class="fa fa-user" aria-hidden="true"></i> Utilizadores</div>
  ...
  <form class="" method="post">
    ...
    <ul >
    <li>
    <a href="?p=listarusuario">Lista do usuários</a>
    </li>
    <li>
    <a href="?p=adicionarusuario">Adicionar usuario</a>
    </li>
    <li>
    <a href="">Exportar lista de utilizadores</a>
    </li>
    </ul>
  </div>
</div>
...
<div class="card-header"><i class="fa fa-video" aria-hidden="true"></i>&nbsp;Videos</div>
  ...
  <form class="" method="post">
    ...
    <ul >
    <li>
    <a href="?p=">Adicionar live</a>
    </li>
    <li>
    <a href="?p">Lista de Reprodução</a>
    </li>
    <li>
